...
function Hero() {
  return (
    <BackgroundBeamsWithCollision className={'flex-col'}>
      <p className="mt-4 sm:text-xl/relaxed font-medium text-white rounded-md p-2 mb-2 bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500">
            Unlock personalized education with AI-driven course creation.
          </p>
      <h2 className="text-2xl relative z-20 md:text-4xl lg:text-7xl font-bold text-center text-black dark:text-white font-sans tracking-tight">
      Create Engaging Courses with{" "} <br />
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
          <Link href={'/dashboard'}>
          <Button className={'bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500'}>Get Started</Button>
          </Link>
          </div>
